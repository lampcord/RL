...
template <typename TNodeID, typename TPosition, unsigned int TNumChildren>
struct Node
{
	Node() : children{} {};
...
template <typename TPosition, unsigned int TMaxNode, unsigned int TNumChildren>
...
public:
	...
	Node<int, TPosition, TNumChildren> * get_node(int node_id);
...
private:
	...
	const int null_id = -1;
	const int root_id = 0;
	array<Node<int, TPosition, TNumChildren>, TMaxNode> nodes;
};


template<typename TPosition, unsigned int TMaxNode, unsigned int TNumChildren>
inline void NodeContainerArray<TPosition, TMaxNode, TNumChildren>::dump()
{
...
template<typename TPosition, unsigned int TMaxNode, unsigned int TNumChildren>
inline int NodeContainerArray<TPosition, TMaxNode, TNumChildren>::initialize(TPosition& position, int player_to_move)
{
...
template<typename TPosition, unsigned int TMaxNode, unsigned int TNumChildren>
inline int NodeContainerArray<TPosition, TMaxNode, TNumChildren>::create_child_node(int parent_id, TPosition& position, int player_to_move, int move)
{
...
template<typename TPosition, unsigned int TMaxNode, unsigned int TNumChildren>
inline Node<int, TPosition, TNumChildren>* NodeContainerArray<TPosition, TMaxNode, TNumChildren>::get_node(int node_id)
{
...
template<typename TNodeID, typename TPosition, unsigned int TNumChildren>
inline void Node<TNodeID, TPosition, TNumChildren>::initialize(TPosition position, int player_to_move, int move, TNodeID parent, TNodeID null_id)
{
...
template<typename TNodeID, typename TPosition, unsigned int TNumChildren>
inline void Node<TNodeID, TPosition, TNumChildren>::dump()
{
	cout << setw(3) << parent << " [ ";
