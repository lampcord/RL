...
# C51
# TBD
# Vmax = common.RAINBOWPARAMS['distributional_vmax']
# Vmin = common.RAINBOWPARAMS['distributional_vmin']
...
if __name__ == "__main__":
    ...
    # TBD
    optimizer = optim.Adam(net.parameters(), lr=common.RAINBOWPARAMS['Adam_learn_rate'])
