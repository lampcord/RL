...
play_mcts_mcts = [game_rules, [MCTSAgent(game_rules, loops=1000000, most_visits=True, rollout_policy=rollout_policy, rollout_count=1000, max_time=1.0),
                               MCTSAgent(game_rules, loops=1000000, most_visits=True, rollout_policy=rollout_policy, rollout_count=1, max_time=1.0)], 1000, None]
