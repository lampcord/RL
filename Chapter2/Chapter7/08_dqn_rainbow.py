...
if __name__ == "__main__":
    ...
    with common.RewardTracker(writer, params['stop_reward']) as reward_tracker:
        while True:
            ...
            if reward_tracker.last_mean_reward is not None and (best_mean_reward is None or best_mean_reward < reward_tracker.last_mean_reward):
                torch.save(net.state_dict(), params['env_name'] + "-best.dat")
                if best_mean_reward is not None:
                    print("Best mean reward updated %.3f -> %.3f, model saved" % (best_mean_reward, reward_tracker.last_mean_reward))
                best_mean_reward = reward_tracker.last_mean_reward
