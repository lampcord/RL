...
from mancalalib import game, mcts
...
def play_game(mcts_stores, replay_buffer, net1, net2, steps_before_tau_0, mcts_searches, mcts_batch_size,
    ...
    while result is None:
        ...
        state, winning_player, swap_players = game.move(state, action, cur_player)
    ...
    if replay_buffer is not None:
        for state, cur_player, probs in reversed(game_history):
            result = 0
            if winning_player == game.PLAYER_WHITE or winning_player == game.PLAYER_BLACK:
